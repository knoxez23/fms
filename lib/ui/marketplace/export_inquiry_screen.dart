...
class _ExportInquiryScreenState extends State<ExportInquiryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Export Product Inquiry'),
      ),
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: const InputDecoration(
                          ...
                          border: OutlineInputBorder(),
                          hintText: 'e.g., Specific packaging, phytosanitary requirements',
                        ),
                        maxLines: 3,
                      ),
                    ],
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const ListTile(
                        ...
                        subtitle: Text('Ensure your product complies with international requirements'),
                      ),
                      const ListTile(
                        leading: Icon(LucideIcons.package, color: Colors.blue),
                        title: Text('Proper packaging available'),
                        subtitle: Text('Export-grade packaging materials'),
                      ),
                      const ListTile(
                        leading: Icon(LucideIcons.truck, color: Colors.orange),
  ...
  void _submitInquiry() {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Export inquiry submitted successfully!')),
      );
