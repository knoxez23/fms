                    ...
                    children: [
                      Stack(
                        children: [
                          CircleAvatar(
                            radius: 35,
                            backgroundColor: _getAnimalColor(widget.animal['type']).withOpacity(0.1),
                            child: Icon(
                            ...
                            Wrap(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: _getStatusColor(widget.animal['status']).withOpacity(0.1),
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 40,
            decoration: BoxDecoration(
              color: isDue ? Colors.red.withOpacity(0.1) : theme.colorScheme.primary.withOpacity(0.1),
              shape: BoxShape.circle,
            ),
            child: Icon(
