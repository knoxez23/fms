...
class _$AddItemImpl implements AddItem {
  ...
  @override
  String toString() {
    return 'InventoryEvent.addItem(itemName: $itemName, category: $category, quantity: $quantity, unit: $unit, minStock: $minStock, supplier: $supplier, unitPrice: $unitPrice, totalValue: $totalValue, notes: $notes, lastRestock: $lastRestock)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, itemName, category, quantity,
      unit, minStock, supplier, unitPrice, totalValue, notes, lastRestock);
  ...
  TResult when<TResult extends Object?>({
    ...
    return addItem(itemName, category, quantity, unit, minStock, supplier,
        unitPrice, totalValue, notes, lastRestock);
  }
...
class _$UpdateItemImpl implements UpdateItem {
  ...
  @override
  String toString() {
    return 'InventoryEvent.updateItem(id: $id, itemName: $itemName, category: $category, quantity: $quantity, unit: $unit, minStock: $minStock, supplier: $supplier, unitPrice: $unitPrice, totalValue: $totalValue, notes: $notes, lastRestock: $lastRestock)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, itemName, category, quantity,
      unit, minStock, supplier, unitPrice, totalValue, notes, lastRestock);
  ...
  TResult when<TResult extends Object?>({
    ...
    return updateItem(id, itemName, category, quantity, unit, minStock,
        supplier, unitPrice, totalValue, notes, lastRestock);
  }
